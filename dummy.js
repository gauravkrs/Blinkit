const navbar=()=>{
    ...
    <ul id="ulM">
        ...
        <li id="lM5"><a href="#" id="lM5M"><span id="h5CM"><i style="color: white;" class="fa-solid fa-cart-shopping"></i></span><span id="h5CM" >Empty</span><span id="h5CM">₹ 0</span></a></li>
            ...
            <div class="LOginDEtailsF">
                <form align="center">
                    ...
                    <div class="NExtBUtton">
                        <button id="SubmitMyMob">Next</button>
                    </div>
                </form>
            </div>
        </div>
